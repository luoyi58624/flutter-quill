...
import 'package:flutter/services.dart'
    show Clipboard, ClipboardData, HardwareKeyboard, KeyDownEvent, LogicalKeyboardKey, SystemChannels, TextInputControl;
...
class QuillRawEditorState extends EditorState
  ...
  void didUpdateWidget(QuillRawEditor oldWidget) {
    ...
    if (controller != oldWidget.configurations.controller) {
      oldWidget.configurations.controller.removeListener(_didChangeTextEditingValue);
